...
export type SectionGridRenderItemInfo<ItemT> =
...
export interface FlatGridProps<ItemType = any>
    extends FlatListProps<ItemType>,
        CommonProps {
    /**
...
export function FlatGrid<ItemType = any>(
    props: React.PropsWithoutRef<FlatGridProps<ItemType>> &
        React.RefAttributes<FlatList<ItemType>>,
): React.ReactElement;
...
export function SectionGrid<ItemType = any>(
    props: React.PropsWithoutRef<SectionGridProps<ItemType>> &
        React.RefAttributes<SectionList<ItemType>>,
): React.ReactElement;
